...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 11) {
                ...
                db.execSQL("DROP TABLE IF EXISTS " + TABLE_RGZBN_GM_CEILING_MOUNTERS);
                db.execSQL("DROP TABLE IF EXISTS " + TABLE_RGZBN_GM_CEILING_MOUNTERS_MAP);
                db.execSQL("DROP TABLE IF EXISTS " + TABLE_RGZBN_GM_CEILING_CALCULATIONS);
                onCreate(db);
