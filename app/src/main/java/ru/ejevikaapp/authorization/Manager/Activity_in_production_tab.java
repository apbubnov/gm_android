...
import ru.ejevikaapp.authorization.Fragments.Fragment_inform_zapysch;
import ru.ejevikaapp.authorization.R;

public class Activity_in_production_tab extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Frag_general_in_production(), "Общее");
        count();
        for (int j = 1; j < i + 1 ; j++) {
