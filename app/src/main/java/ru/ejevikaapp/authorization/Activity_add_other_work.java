...
import ru.ejevikaapp.authorization.Class.Other_comp_and_work_class;

public class Activity_add_other_work extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_other_work);
        ...
        Cursor cursor = db.query(DBHelper.TABLE_OTHER_WORK, null, "calculation_id =?", new String[]{id_calc}, null, null, null);
        ...
        list_diff.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Activity_add_other_work.this);
                        ...
                        .setPositiveButton("Да",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        dbHelper = new DBHelper(Activity_add_other_work.this);
                                        SQLiteDatabase db = dbHelper.getReadableDatabase();
                                        Cursor cursor = db.query(DBHelper.TABLE_OTHER_WORK, null, null, null, null, null, null);
//
                                        if (cursor.moveToFirst()) {
                                            int kd_Index = cursor.getColumnIndex(DBHelper.KEY_ID);
                                            do {
                                                if (s_id.equals(cursor.getString(kd_Index))) {
                                                    db.delete(DBHelper.TABLE_OTHER_WORK, "_id = ?", new String[]{String.valueOf(s_id)});
                                                }
                                            }
                                            while (cursor.moveToNext());
                                        }
                                        Intent intent = new Intent(Activity_add_other_work.this, Activity_add_other_work.class);
                                        ...
                                        Toast toast = Toast.makeText(getApplicationContext(),
                                                "Работа удалёна ", Toast.LENGTH_SHORT);
                                        toast.show();
                                    }
                                })
        ...
        switch (v.getId()) {
            case R.id.btn_add_work:
                ...
                if (count>0) {
                    ...
                    db.insert(DBHelper.TABLE_OTHER_WORK, null, values);

                    toast = Toast.makeText(getApplicationContext(),
                            "Работа добавлена ", Toast.LENGTH_SHORT);
                    toast.show();

                    Intent intent = new Intent(this, Activity_add_other_work.class);
                    intent.putExtra("id_calc", id_calc);
                    finish();
