...
public class Fragment_inform_proj extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_inform_proj, container, false);
            ...
            if (c.moveToFirst()) {
                do {
                   ...
                   try {
                    ...
                    String n16 = c.getString(c.getColumnIndex(c.getColumnName(12)));
                            ...
                            (Double.valueOf(c.getString(c.getColumnIndex(c.getColumnName(27)))) > 0))
                    {
                        ...
                        String n17 = c.getString(c.getColumnIndex(c.getColumnName(13)));
    ...
    void fun_builder() {
        ...
        builder.setTitle(s_setTitle)
                .setMessage(s_setMessage)
                .setIcon(null)
                .setCancelable(false)
                .setPositiveButton("Да",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                String id_calc = String.valueOf(id_pagenumber.getText());
                                SQLiteDatabase db = dbHelper.getReadableDatabase();
                                ...
                                Toast toast = Toast.makeText(getActivity().getApplicationContext(),
                                        "Расчёт удалён ", Toast.LENGTH_SHORT);
                                toast.show();
                            }
                        })
