...
public class Activity_add_profile extends AppCompatActivity implements View.OnClickListener {

    DBHelper dbHelper;
    EditText kol_vo_profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c = db.query("rgzbn_gm_ceiling_type", null, "_id between 12 and 16", null, null, null, null);
        if (c != null) {
            if (c.moveToFirst()) {
                do {
        ...
        kol_vo_profile = (EditText) findViewById(R.id.kol_vo_profile);
        ...
        Cursor cursor = db.query(DBHelper.TABLE_RGZBN_GM_CEILING_PROFIL, null, "calculation_id =?", new String[]{id_calc},
                null, null, null);
        ...
        list_profile.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Activity_add_profile.this);
                        ...
                        .setPositiveButton("Да",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        dbHelper = new DBHelper(Activity_add_profile.this);
                                        ...
                                        Intent intent = new Intent(Activity_add_profile.this, Activity_add_profile.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_add_profile:
                Toast toast;
                String kol_vo = kol_vo_profile.getText().toString().trim();
                int count = 0;
                if (kol_vo.length() == 0) {
                    count = 0;
                ...
                if (count > 0) {
                    ...
                    values.put(DBHelper.KEY_N29_TYPE, size);
                    ...
                    Intent intent = new Intent(this, Activity_add_profile.class);
                    intent.putExtra("id_calc", id_calc);
                    finish();
