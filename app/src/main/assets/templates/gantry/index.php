...
<!--	<meta name="msapplication-tap-highlight" content="no">-->
   ...
   <!--<script src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
	...
	<script src="/templates/gantry/js/jquery.modal.min.js" type="text/javascript"></script>
	...
	<link rel="stylesheet" href="/templates/gantry/fonts/cuprum.css">
...
<body <?php echo $gantry->displayBodyTag(); ?>>
	<!--<div id="sketch_editor" class="sketch_window" style="display: none;">
		<canvas style="margin-top:45px" id="myCanvas" resize></canvas>
		...
		<label class="sketch_hud btn btn-success drag_check"><input id="drag" type="checkbox" class="check"><span></span></label>
		<button id="close_sketch" class="sketch_hud btn btn-success">Ok</button>
		<button id ="createScreenshot" class="sketch_hud" style="display:none;">Сделать скриншот</button>
		<img id = 'screen' url="/templates/gantry/images/img.png" alt="sketch" class="sketch_hud">
		<div id="window" class="sketch_hud">
			<center>
				<input name="newLength" id="newLength" value="" placeholder="Введите длину">
				<br>
				<input id = "ok" type="button" value="ОК">
				<input id = "close" type="button" value="Закрыть">
			</center>
		</div>
		<button class="sketch_hud btn btn-primary" id ="cancelLastAction" ><i class="fa fa-reply" aria-hidden="true"></i> </button>
		<button class="sketch_hud btn btn-danger" id ="reset" ><i class="fa fa-undo" aria-hidden="true"></i></button>
		<button class="sketch_hud btn btn-warning" id ="setDiagonals" hidden = true ><i class="fa fa-external-link" aria-hidden="true"></i> Задать диагонали</button>
	</div>-->
	...
	<script>
		...
		jQuery( document ).ready(function(){
			...
			jQuery("#myCanvas").attr("width", jQuery(window).width() +"px");
				jQuery("#myCanvas").attr("height", jQuery(window).height()+"px");
