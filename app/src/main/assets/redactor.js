...
function begin()
{
	...
	var walls_points = fun_canv.get_walls_points();

    js_polotna = JSON.parse(walls_points);
    width_polotna = js_polotna;
	walls_points = width_polotna;
	...
	var diags_points = fun_canv.get_diags_points();
	...
	var pt_points = fun_canv.get_pt_points();
...
function save_data(){
    ...
    alert("p_usadki " +p_usadki );
    alert("sq_obrezkov " + sq_obrezkov );
    alert("cuts_json " + cuts_json );
